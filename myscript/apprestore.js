...
const getRestore = async () => {
  try {
    ...
    await axios.get(`https://${mainUrl}/shop/init`,myheader)
    await axios.post(`https://${mainUrl}/shop/restore`,shopQry,myheader)
    await axios.post(`https://${mainUrl}/user/restore`,userQry,myheader)
    await axios.post(`https://${mainUrl}/basicdata/restore`,basicdataQry,myheader)
    await axios.post(`https://${mainUrl}/job/restore`,jobQry,myheader)
